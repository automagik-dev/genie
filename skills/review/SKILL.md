...
The reviewer is different from the author and remains read-only. Return findings and a verdict; the caller owns fixes, records, task state, and delivery. Assess the requested scope against user criteria and repository contracts.
