...
CLAUDE.md is a first-class surface: when commands or conventions change, it must change too.

## Flow
1. **Audit** — map what exists across the surfaces above.
2. **Diff against code** — find missing, stale, or wrong claims; CLAUDE.md accuracy first.
