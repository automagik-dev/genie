...
| `refine` | Rewrite a brief, draft, or system prompt using official OpenAI or Claude guidance (`--for openai` or `--for claude`), keeping its intent | A prompt needs sharpening, or a brief precedes dispatch |
