 ...
 * `--print-update-capabilities --json` probe reporting exactly
...
/** The single intent schema currently written by the activation store. */
...
/**
 * The `--print-update-capabilities --json` handler: emit exactly one
