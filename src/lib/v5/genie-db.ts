...
-- with evidence. Additive and nullable at creation, so this stays within
-- user_version = 1 — no destructive migration, no version bump. A row starts
-- unchecked; checked_at NULL means open, non-NULL means done.
