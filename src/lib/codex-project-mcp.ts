...
// ============================================================================
// Route-layer classifier (typed config-layer diagnostics)
// ============================================================================
//
// Moved verbatim out of the retired Codex lifecycle-truth module: these findings
// are MCP route-layer diagnostics, owned by the dual-mode MCP surface rather
// than by the Codex plugin activation lifecycle that was deleted around them.
// Reports only — a collision or shadowing layer is preserved exactly as found.
