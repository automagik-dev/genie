...
3. After `fix` completes, re-run `review` (resolved fix-loop budget; default 2 unless a higher-priority instruction overrides it, capped at 5 without a recorded human decision).
