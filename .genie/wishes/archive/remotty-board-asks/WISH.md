...
| Field | Value |
|-------|-------|
| **Status** | SHIPPED — PR [#2755](https://github.com/automagik-dev/genie/pull/2755) merged to dev 2026-08-07 (4/4 groups execution-reviewed SHIP); header reconciled + archived 2026-08-24 |
