...
### Council — skill categories, absorbed skills, sub-plugin manager (2026-09-15)

- **Question:** adopt the 15-repo DSH ecosystem synthesis (run `wf_a9e7dfa1-c02`, 17 Opus readers) in one wave: eight skill categories as frontmatter, absorb 11 external skills, 11 improve edits, a manager-plus-sub-plugin restructure of this plugin modelled on `dsh-codex-ui`, and three config surfaces.
- **Run:** `council` workflow on Opus, run `wf_4a38e709-82e`. Verdicts: architecture, delivery, product, security support-with-conditions; dissent oppose. Synthesis: **proceed-with-conditions**.
